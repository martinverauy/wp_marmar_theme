 ...
 * @return array
 */
function wp_marmar_theme_body_classes( $classes ) {
...
add_filter( 'body_class', 'wp_marmar_theme_body_classes' );
...
function all_excerpts_get_more_link( $post_excerpt ) {
	return $post_excerpt . '... <a href="' . get_permalink( get_the_ID() ) . '">' . __( 'Read more', 'WP_MarMar_Theme' ) . '</a>';
}
 ...
 * @return void
 */
function wp_marmar_theme_pingback_header() {
	if ( is_singular() && pings_open() ) {
		echo '<link rel="pingback" href="', esc_url( get_bloginfo( 'pingback_url' ) ), '">';
	}
}
add_action( 'wp_head', 'wp_marmar_theme_pingback_header' );
