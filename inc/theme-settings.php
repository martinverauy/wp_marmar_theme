...
add_action('admin_menu', 'wp_marmar_theme_admin');
function wp_marmar_theme_admin() {
  add_menu_page(
  'Mar&Mar Options',  // Admin page title
  'Mar&Mar Options',  // Admin menu label
  'manage_options',
  'wp_marmar_theme_options', // Admin slug
  'wp_marmar_theme_page'); // Display Page
}

add_action('admin_init', 'wp_marmar_theme_items');
function wp_marmar_theme_items() { 
  $settings = array(
    'wp_marmar_theme_id' => array(
 ...
 * Display Page
 ***************************************/
function wp_marmar_theme_page() {
?>
    <div class="wrap">  
        <div id="icon-themes" class="icon32"></div>  
        <h2>WP_MarMar_Theme</h2>  
        <?php settings_errors(); ?>   
